...
-- Generated on Sat Jan 16 23:48:05 2021
...
---@overload fun(name: 'shardReady', fn: fun(shardId: number))
---@overload fun(name: 'shardResumed', fn: fun(shardId: number))
---@overload fun(name: 'channelCreate', fn: fun(channel: Channel))
---@overload fun(name: 'channelUpdate', fn: fun(channel: Channel))
---@overload fun(name: 'channelDelete', fn: fun(channel: Channel))
---@overload fun(name: 'recipientAdd', fn: fun(channel: Channel, user: User))
---@overload fun(name: 'recipientRemove', fn: fun(channel: Channel, user: User))
---@overload fun(name: 'guildAvailable', fn: fun(guild: Guild))
---@overload fun(name: 'guildCreate', fn: fun(guild: Guild))
---@overload fun(name: 'guildUnavailable', fn: fun(guild: Guild))
---@overload fun(name: 'guildDelete', fn: fun(guild: Guild))
---@overload fun(name: 'userBan', fn: fun(user: User, guild: Guild))
---@overload fun(name: 'userUnban', fn: fun(user: User, guild: Guild))
---@overload fun(name: 'emojisUpdate', fn: fun(guild: Guild))
---@overload fun(name: 'memberJoin', fn: fun(member: Member, guild: Guild))
---@overload fun(name: 'memberLeave', fn: fun(member: Member, guild: Guild))
---@overload fun(name: 'memberUpdate', fn: fun(member: Member, guild: Guild))
---@overload fun(name: 'roleCreate', fn: fun(role: Role))
---@overload fun(name: 'roleUpdate', fn: fun(role: Role))
---@overload fun(name: 'roleDelete', fn: fun(role: Role))
---@overload fun(name: 'messageCreate', fn: fun(message: Message))
---@overload fun(name: 'messageUpdate', fn: fun(message: Message))
---@overload fun(name: 'messageUpdateUncached', fn: fun(channel: TextChannel, messageId: string))
---@overload fun(name: 'reactionAdd', fn: fun(reaction: Reaction, userId: string))
---@overload fun(name: 'reactionAddUncached', fn: fun(channel: TextChannel, messageId: string, hash: string, userId: string))
---@overload fun(name: 'reactionRemove', fn: fun(reaction: Reaction, userId: string))
---@overload fun(name: 'reactionRemoveUncached', fn: fun(channel: TextChannel, messageId: string, hash: string, userId: string))
---@overload fun(name: 'pinsUpdate', fn: fun(channel: TextChannel))
---@overload fun(name: 'presenceUpdate', fn: fun(member: Member))
---@overload fun(name: 'relationshipUpdate', fn: fun(relationship: Relationship))
---@overload fun(name: 'relationshipAdd', fn: fun(relationship: Relationship))
---@overload fun(name: 'relationshipRemove', fn: fun(relationship: Relationship))
---@overload fun(name: 'typingStart', fn: fun(userId: string, channelId: string, timestamp: string))
---@overload fun(name: 'userUpdate', fn: fun(user: User))
---@overload fun(name: 'voiceConnect', fn: fun(member: Member))
---@overload fun(name: 'voiceUpdate', fn: fun(member: Member))
---@overload fun(name: 'voiceChannelJoin', fn: fun(member: Member, channel: GuildVoiceChannel))
---@overload fun(name: 'voiceChannelLeave', fn: fun(member: Member, channel: GuildVoiceChannel))
---@overload fun(name: 'webhooksUpdate', fn: fun(channel: TextChannel))
---@overload fun(name: 'debug', fn: fun(message: string))
---@overload fun(name: 'info', fn: fun(message: string))
---@overload fun(name: 'warning', fn: fun(message: string))
---@overload fun(name: 'error', fn: fun(message: string))
---@overload fun(name: 'heartbeat', fn: fun(shardId: number, latency: number))
---@overload fun(name: 'raw', fn: fun(json: string))
...
---@overload fun(name: string, ...): table, table, table
local class = {}
