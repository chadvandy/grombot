...
\*In WH3 (and maybe onwards), movie-type pack files no longer are required for VFX changes.]=],
		...
		["Disable pings"] = {
			["ticket_num"] = 50,
			["field"] = [=[Please disable pings when quoting and it's not an urgent matter. Many users can be annoyed by unnecessary notifications when all you're doing is referencing a message. No, it can't be disabled by default, blame discord. https://cdn.discordapp.com/attachments/373745291289034765/778933419547295744/unknown.png]=],
			["creation_time"] = 0,
			["num_uses"] = 74,
			["tags"] = {
			},
