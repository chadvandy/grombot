	...
	["moddr"] = {
		["offers"] = {
			...
			[1] = {
				["user_id"] = [=[364410374688342018]=],
				["ticket_num"] = 1,
				["str"] = [=[I'm available for any small scripts that need writing, or any similarly small UI projects (implementation, not art!), on the one condition that it'll probably take me a while to get around to it 🙂]=],
			},
		},
		["requests"] = {
			[2] = {
...
I want to make it so the difficulty you choose affects the units that spawn. I imagine this requires a read condition of what difficulty is selected, and then it'll load a specific script. I just need a hand setting up this read condition. Cheers.]=],
			...
			[4] = {
				["user_id"] = [=[435693203405013002]=],
				["ticket_num"] = 14,
				["str"] = [=[Looking for a content creator to do a more up-to-date video/Youtube on the current version of the mod. Very thankful to GBOG's and Broken Load Order for their Youtube videos, but the mod has had some quite significant changes and updates the past year and so it would be nice to have a more up-to-date vids which show the full range of the newest updates etc. So if you are a content creator and are interested please do reach out to me on Da Modding Den Discord. 🙂]=],
			},
			[6] = {
				["user_id"] = [=[230807829819293706]=],
				["ticket_num"] = 20,
				["str"] = [=[hey, i made some models, and pretty much im looking for someone to turn like 6 or so into heroes, i have stats and everything written down, models are all set! so its like... the other 90%, the harder part of this. its pretty much some heroes of friend's dnd characters. so i guess what you'd get out of this is using the models, or recycling them for your own purpose (ideally id get credit for the models ykyk) but yeah youd be able to use them with whatever.]=],
			},
		},
	},
}
